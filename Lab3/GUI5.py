...
class MainFrame(wx.Frame):
    ...
    def __init__(self):
        wx.Frame.__init__(self, None, -1, "Обработка строк", size=(400, 300))
        ...
        sc.SetRange(1, 20)
        sc.SetValue(5)
        self.clean_checkbox = wx.CheckBox(panel, -1, "Удалить слова размером меньше",(70, 60), (220, 20))
    ...
    def on_format_click(self, event):
        ...
        if self.clean_checkbox.IsChecked():
            result = StringFormatter.del_worlds(result, int(self.size_spin.Value))
